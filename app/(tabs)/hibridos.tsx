// app/(tabs)/hibridos.tsx
// Pantalla de Híbridos (dragón-humano)
...
export default function HibridosScreen() {
  ...
  const hybrids = getFiltered('hybrid', currentFilter);
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              <Text style={[styles.emptyText, { color: theme.colors.text }]}>
                No hay híbridos registrados
              </Text>
              <Text style={[styles.emptySubtext, { color: theme.colors.textSecondary }]}>
                Los híbridos son seres con sangre de dragón y humano
              </Text>
            </View>
          }
        />
